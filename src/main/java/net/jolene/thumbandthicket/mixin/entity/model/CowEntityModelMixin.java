...
public class CowEntityModelMixin {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 33).cuboid(-4.0F, -5.0F, -7.0F, 8.0F, 10.0F, 6.0F, new Dilation(0.0F))
                .uv(40, 52).cuboid("right_horn",4.0F, -6.0F, -5.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(44, 52).cuboid("left_horn",-5.0F, -6.0F, -5.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(40, 49).cuboid("right_ear",4.0F, -4.0F, -4.0F, 3.0F, 3.0F, 0.0F, new Dilation(0.0F))
                .uv(46, 49).cuboid("left_ear",-7.0F, -4.0F, -4.0F, 3.0F, 3.0F, 0.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.0F, 3.0F, -6.0F));
        modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, -6.0F, -10.0F, 12.0F, 13.0F, 20.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 5.0F, 3.0F));
        modelPartData.getChild("body").addChild("tail", ModelPartBuilder.create().uv(32, 49).cuboid(-2.0F, -17.0F, -9.0F, 4.0F, 10.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 12.0F, 19.0F, 0.0F, 0.0F, 0.0F));
        ...
        return TexturedModelData.of(modelData, 64, 80);
    }
