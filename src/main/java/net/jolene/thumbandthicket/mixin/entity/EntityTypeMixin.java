...
public class EntityTypeMixin {
    ...
    private static EntityType<CowEntity> thumbandthicket$changeCowHitbox(String id, EntityType.Builder<CowEntity> type, Operation<EntityType<CowEntity>> original) {
