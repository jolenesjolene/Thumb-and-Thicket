...
public class BrownBearAnimations {
        ...
        public static final Animation sleep = Animation.Builder.create(2.0F).looping()
                ...
                .addBoneAnimation("nose", new Transformation(Transformation.Targets.SCALE,
                        ...
                        new Keyframe(1.0F, AnimationHelper.createScalingVector(1.0F, 1.3F, 1.0F), Transformation.Interpolations.CUBIC),
                        new Keyframe(2.0F, AnimationHelper.createScalingVector(1.0F, 1.2F, 1.0F), Transformation.Interpolations.CUBIC)
                ))
                .addBoneAnimation("right_ear", new Transformation(Transformation.Targets.ROTATE,
                        new Keyframe(0.0F, AnimationHelper.createRotationalVector(67.5F, 45.0F, 0.0F), Transformation.Interpolations.LINEAR)
                ))
                .addBoneAnimation("left_ear", new Transformation(Transformation.Targets.ROTATE,
                        ...
                        new Keyframe(1.5833F, AnimationHelper.createRotationalVector(-35.0F, 0.0F, 35.0F), Transformation.Interpolations.CUBIC),
                        new Keyframe(1.75F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 35.0F), Transformation.Interpolations.CUBIC)
                ))
                .build();
