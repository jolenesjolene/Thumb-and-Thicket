...
public class MooseModel<T extends MooseEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(0, 44).cuboid(-3.5F, -8.0F, -24.0F, 7.0F, 8.0F, 18.0F, new Dilation(0.0F))
                .uv(82, 24).cuboid(0.0F, 0.0F, -19.0F, 0.0F, 8.0F, 7.0F, new Dilation(0.0F))
                .uv(50, 44).cuboid(-3.5F, -4.0F, -12.0F, 7.0F, 12.0F, 14.0F, new Dilation(-0.01F))
                .uv(50, 88).cuboid(3.5F, -11.0F, -10.0F, 0.0F, 3.0F, 4.0F, new Dilation(0.0F))
                .uv(42, 88).cuboid(-3.5F, -11.0F, -10.0F, 0.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -16.0F, -6.0F));

        ModelPartData antlers = head.addChild("antlers", ModelPartBuilder.create().uv(0, 70).cuboid(-13.5F, -8.0F, -3.0F, 10.0F, 8.0F, 10.0F, new Dilation(-0.01F))
                .uv(40, 70).cuboid(3.5F, -8.0F, -3.0F, 10.0F, 8.0F, 10.0F, new Dilation(-0.01F)), ModelTransform.pivot(0.0F, -6.0F, -9.0F));

        ModelPartData tail = body.addChild("tail", ModelPartBuilder.create().uv(32, 88).cuboid(-2.0F, 0.0F, 0.0F, 5.0F, 8.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-0.5F, -14.0F, 14.1F, 0.2182F, 0.0F, 0.0F));

        ModelPartData front_left_leg = root.addChild("front_left_leg", ModelPartBuilder.create().uv(82, 0).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 20.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(4.5F, -20.0F, -11.0F));

        ModelPartData front_right_leg = root.addChild("front_right_leg", ModelPartBuilder.create().uv(0, 88).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 20.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.5F, -20.0F, -11.0F));

        ModelPartData back_right_leg = root.addChild("back_right_leg", ModelPartBuilder.create().uv(16, 88).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 20.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.5F, -20.0F, 11.0F));

        ModelPartData back_left_leg = root.addChild("back_left_leg", ModelPartBuilder.create().uv(80, 70).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 20.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(4.5F, -20.0F, 11.0F));
