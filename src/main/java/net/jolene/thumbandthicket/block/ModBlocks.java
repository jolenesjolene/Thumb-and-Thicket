...
public class ModBlocks {
    ...
    public static final Block SNOWY_BUSH = register(new ActualBushBlock(AbstractBlock.Settings.copy(com.blackgear.vanillabackport.common.registries.ModBlocks.BUSH.get())), "snowy_bush", true);
    public static final Block SNOWY_SHORT_GRASS = register(new ShortPlantBlock(AbstractBlock.Settings.copy(Blocks.SHORT_GRASS)), "snowy_short_grass", true);
